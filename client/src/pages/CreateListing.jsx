      ...
      <main className="p-3 max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-5">
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <button disabled = {loading || uploading} className="bg-sky-600 p-3 rounded-md text-white uppercase disabled:opacity-60 hover:opacity-80">{loading ? 'Creating...': 'create listing'}</button>
