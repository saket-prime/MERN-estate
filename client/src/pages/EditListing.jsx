            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-5">
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <input
                        type="text"
                        placeholder="Name"
                        className="p-3 border rounded-md outline-sky-500"
                        id="name"
                        maxLength='62'
                        minLength='10'
                        required
                    ...
                    <textarea type="textarea" placeholder="Description" className=" p-3 border rounded-md outline-sky-500"
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button disabled={loading || uploading} className="bg-green-600 p-3 rounded-md text-white uppercase disabled:opacity-60 hover:opacity-80">{loading ? 'updating...' : 'update listing'}</button>
